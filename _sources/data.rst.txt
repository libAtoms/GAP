...
.. list-table:: GAP models
   ...
   * - `Li @ C <https://www.repository.cam.ac.uk/handle/1810/307758>`_
     ...
     - `The Li-C interaction potential is to be added onto a carbon potential that is not included`_
   * - `aC <https://www.repository.cam.ac.uk/handle/1810/262814>`_
     ...
     - `Potential for amorphous carbon - not particularly accurate for crystals, and does not include any vdW interaction`_
   * - `Si <https://doi.org/10.17863/CAM.65004>`_
     ...
     - `A general purpose Si potential`_
   ...
   * - `Si:H <https://github.com/dgunruh/Si-H-GAP>`_
     ...
     - `Includes a lot of the general Si potential plus interaction with H`_